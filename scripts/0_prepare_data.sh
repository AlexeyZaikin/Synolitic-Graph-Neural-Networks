...
uv run sgnn/obtain_data.py $DATASET_PATH $SAVE_PATH --data_size=1.0 --n_folds=5
...
uv run sgnn/obtain_data.py $DATASET_PATH $SAVE_PATH --data_size=0.01
uv run sgnn/preprocessing.py $SAVE_PATH --data_size=0.01
